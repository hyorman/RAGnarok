...
describe("HybridRetriever", function () {
  ...
  const testDocuments: LangChainDocument[] = [
    ...
    new LangChainDocument({
      pageContent:
        "JavaScript is a scripting language for web browsers. JavaScript enables interactive web pages and web applications.",
      metadata: { source: "js-intro.md", id: "doc2" },
    }),
    new LangChainDocument({
      pageContent:
        "Machine learning is a subset of artificial intelligence. Python is the most popular language for machine learning.",
      metadata: { source: "ml-intro.md", id: "doc3" },
    }),
    new LangChainDocument({
      pageContent:
        "TypeScript is a typed superset of JavaScript that compiles to plain JavaScript. TypeScript adds optional static typing.",
