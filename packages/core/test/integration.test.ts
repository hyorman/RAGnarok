...
describe("Integration Tests", function () {
  ...
  describe("End-to-End Simple Query Workflow", function () {
    ...
    beforeEach(async function () {
      ...
      ragAgent = new RAGAgent(mockConfig, mockLLMProvider);
  ...
  describe("Chunking and Embedding Integration", function () {
    it("should chunk and embed documents together", async function () {
      const sourceDoc = new LangChainDocument({
        pageContent:
          "This is a long document that needs to be chunked. It has multiple sentences. Each sentence provides different information. The chunker should split this appropriately.",
    ...
    it("should store chunked documents in vector store", async function () {
      const sourceDoc = new LangChainDocument({
        pageContent:
          "Python programming language is great for beginners. JavaScript is essential for web development. TypeScript improves JavaScript development.",
        metadata: { source: "test.txt" },
      });
      ...
      const vectorStore = await TestVectorStore.fromDocuments(chunkResult.chunks, testEmbeddings);
  ...
  describe("Error Handling Across Components", function () {
    ...
    it("should handle empty vector store queries", async function () {
      const emptyVectorStore = await TestVectorStore.fromDocuments([], testEmbeddings);
